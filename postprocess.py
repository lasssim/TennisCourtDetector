...
def postprocess(heatmap, scale_x, scale_y, crop_x, crop_y, low_thresh=155, min_radius=10, max_radius=30):
    ...
    if circles is not None:
        x_pred = circles[0][0][0] * scale_x + crop_x
        y_pred = circles[0][0][1] * scale_y + crop_y 
